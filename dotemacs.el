...
(custom-set-variables
 ...
 '(package-selected-packages
   '(company-box company exec-path-from-shell yasnippet-snippets modern-cpp-font-lock org-roam smartparens rainbow-delimiters json-mode yaml-mode magit orderless kind-icon corfu-terminal corfu marginalia vertico embark-consult embark consult avy which-key)))
(custom-set-faces
...
(defvar prelude-modules-dir
  (cond ((eq system-type 'gnu/linux) "~/doc/emacs/modules")
...
(defun load-config-el (fname)
  (let ((el-file-path (cond ((eq system-type 'gnu/linux) "~/doc/emacs")
			    ...
			    ((eq system-type 'windows-nt) "d:/doc/emacs"))))
    (load-file (concat (file-name-as-directory el-file-path) fname))))
